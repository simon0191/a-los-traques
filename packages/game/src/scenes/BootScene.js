...
import { isAuthEnabled } from '../services/supabase.js';
...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    // Pin the loader to the origin root so `assets/…` resolves from `/assets/…`
    // regardless of the page URL (`/play`, `/admin/...`, etc.).
  ...
  create() {
    ...
    const startNextScene = () => {
      ...
      } else if (!isAuthEnabled() || this.game.autoplay?.enabled) {
